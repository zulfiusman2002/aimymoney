...
// Model selection — override in Netlify: Site settings → Environment variables
// ANTHROPIC_MODEL_FAST: quick analyses (budget, goals, risk, savings, networth, portfolio)
// ANTHROPIC_MODEL_FULL: full-review + advisor chat (can be same or larger model)
// Default: claude-haiku-4-5-20251001 (confirmed working on this account)
...
console.log('[AI-MY-MONEY] Function loaded.', { MODEL_FAST, MODEL_FULL });
