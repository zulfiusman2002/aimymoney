...
// Fallbacks use claude-3-haiku-20240307 — the Claude 3 model available on ALL API key tiers.
// Run /.netlify/functions/anthropic-test to find what your specific key supports,
// then override with ANTHROPIC_MODEL_FAST and ANTHROPIC_MODEL_FULL in Netlify env vars.
const MODEL_FAST = process.env.ANTHROPIC_MODEL_FAST || 'claude-3-haiku-20240307';
const MODEL_FULL = process.env.ANTHROPIC_MODEL_FULL || 'claude-3-haiku-20240307';
