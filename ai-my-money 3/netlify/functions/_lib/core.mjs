...
const MODEL_FAST = process.env.ANTHROPIC_MODEL_FAST || 'claude-3-5-haiku-20241022';
const MODEL_FULL = process.env.ANTHROPIC_MODEL_FULL || 'claude-3-5-haiku-20241022';
