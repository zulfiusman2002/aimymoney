  ...
  return (
    <div className="page">
      <div className="fade-up" style={{ marginBottom: 24 }}>
        <div className="t-label">Built from your actual net worth of {f(src.comp.netWorth)} — not hypothetical numbers</div>
      ...
      <div className="card" style={{ marginBottom: 18 }}>
        <div className="t-label" style={{ marginBottom: 10 }}>Contributions vs growth · base scenario (nominal)</div>
        ...
        {scenarios.base.at(-1).growth > scenarios.base.at(-1).contributions && (
          <p style={{ fontSize: '.74rem', color: 'var(--c-muted)', marginTop: 8 }}>
